...
import { EMPTY_STRING } from "../../../discord/src/constants"
...
import { renderComponentNodes } from "./helpers/render-nodes"
...
export const renderMessageContent = (root: AronaNode) => {
	const { components, files, interactionListeners } = renderComponentNodes(
		root.children,
	)
